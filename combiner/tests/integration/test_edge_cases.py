...
#end#file1.txt#/end#
"""
        part2_content = """#begin#file2.txt#1#text#/begin#
File 2 content
#end#file2.txt#/end#
"""
       
        (encoded_dir / "combined_part001.txt").write_text(part1_content, encoding='utf-8')
        (encoded_dir / "combined_part002.txt").write_text(part2_content, encoding='utf-8')
        ...
        # Both files should be decoded
        file1 = temp_output_dir / "file1.txt"
        file2 = temp_output_dir / "file2.txt"
       
        assert file1.exists()
        assert file2.exists()
        assert "File 1 content" in file1.read_text(encoding='utf-8')
        assert "File 2 content" in file2.read_text(encoding='utf-8')
